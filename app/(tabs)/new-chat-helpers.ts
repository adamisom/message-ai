...
import { formatPhoneNumber, extractDigits } from '../../utils/phoneFormat';

// Re-export phone formatting functions for backwards compatibility
export { formatPhoneNumber, extractDigits };
